...
ACCOUNT_SIGNUP_FORM_CLASS = 'accounts.auth_forms.EscrowSignupForm'
...
OPENAI_PURCHASE_AGREEMENT_API_KEY = os.getenv("OPENAI_PURCHASE_AGREEMENT_API_KEY", OPENAI_API_KEY)
OPENAI_PURCHASE_AGREEMENT_MODEL = os.getenv("OPENAI_PURCHASE_AGREEMENT_MODEL", "gpt-4o-mini")
